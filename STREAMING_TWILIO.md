...
| `DEEPGRAM_ENDPOINTING_MS` | Silences (ms) avant de finaliser la phrase | 800 par défaut ; plus élevé = moins de découpage (ex. « tu » / « m'enlever les champignons ») |
| `DEEPGRAM_UTTERANCE_END_MS` | Gap (ms) pour émettre UtteranceEnd | 1500 par défaut |
